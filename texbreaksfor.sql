...
--
-- Host: 127.0.0.1    Database: codenewbies
-- ------------------------------------------------------
...
CREATE TABLE `quizanswers` (
  `answerId` int NOT NULL COMMENT 'Unique ID ',
  `cardId` int DEFAULT NULL COMMENT 'pointer to cards table',
  `answerText` varchar(100) DEFAULT NULL COMMENT 'The text that appears for the question indicated by the question ID',
  `correctAnswer` tinyint DEFAULT '0' COMMENT '1 = this is the correct answer for the question\n0 = not the correct answer (default)\n',
...
INSERT INTO `users` VALUES (1,'Maddie Conaway','mc@ib.com','maddie','robots1!','Beginner'),(2,'Cat Callahan','cc@ib.com','cat','robots2@','Intermediate'),(3,'Josh Hurn','jh@ib.com','josh','robots3#','Advanced'),(7,'ok','ii','lol','test','Beginner'),(8,'lol','lol','lol','lol','Beginner');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'codenewbies'
--
...
-- Dump completed on 2020-04-17  9:02:44