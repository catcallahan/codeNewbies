...
const About: React.FC<AboutProps> = () => {
    ...
    return (
        <React.Fragment>
            ...
            <div className="bg-darkBlue rounded text-center mt-4 container-fluid mt-4">
           ...
           <span  className="col-sm-10 rounded shadow-lg mt-4 pl-4 pr-4 mb-4 pt-4 pb-4 " style={{backgroundColor: 'F9E5E4'}}>
               ...
               <div className="justify-content-center d-flex">
                   <div className='row mt-4 justify-content-center'>
                        ...
                        <div className="col-sm-4 d-flex mr-4 pl-4 flex-column ">
                            <h1 className="text-white">What's the problem?</h1>
                                <h4 className="text-darkBlue text-left">
                                    ...
                                    be presented at you in an interview by a potential employer. 
                        ...
                        <div className="col-sm-4 d-flex ml-4 pr-4 flex-column">
               ...
               <div className="d-flex mt-4 mb-4 pb-4 justify-content-around">
               <div className="d-flex flex-column w-75">
                    <h4 className="text-white">Leave Us A Comment</h4>
                    <textarea rows={8} id="comment" className="rounded shadow border" ></textarea>
