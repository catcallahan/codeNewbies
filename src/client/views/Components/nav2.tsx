			...
			<div>
				<nav className="navbar navbar-expand-lg navbar-light bg-darkBlue">
					...
					<div className="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
						...
						<Link className="nav-item nav-link justify-content-right text-white" to ='/quiz'>chooseCategory</Link>
						<Link className="nav-item nav-link justify-content-right text-white" to ='/quiz'>quizMe</Link>
